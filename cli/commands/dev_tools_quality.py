"""Quality-analysis mixin — /complexity, /deadcode, /bandit, /precommit."""
...
class DevToolsQualityMixin:
    """Mixin providing quality and security analysis commands.

    Expects ``self._require_workspace()`` from ``DevToolsCommands``.
    """
